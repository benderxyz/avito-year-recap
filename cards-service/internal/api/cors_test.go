...
func TestWithCORSShouldAllowConfiguredOrigin(t *testing.T) {
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/api/recap/2026/42", nil)
...
func TestWithCORSShouldAnswerPreflight(t *testing.T) {
	req := httptest.NewRequestWithContext(context.Background(), http.MethodOptions, "/api/recap/2026/42", nil)
	req.Header.Set("Origin", "http://localhost:3000")
